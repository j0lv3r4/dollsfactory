    ...
    <footer class="site-footer bg-brand-dark text-light pt-4 pb-4">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					...
					<p>&copy; 2018 Dolls Factory Makeup Studio. All Rights Reserved.</p>
				</div> <!-- .col-md-6 -->

				<div class="col-md-3 ml-auto">
					<img class="footer-image" src="/assets/img/19.png">
				</div>
			</div>
		</div>
    </footer>
